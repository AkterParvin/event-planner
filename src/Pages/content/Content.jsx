...
const Content = () => {
    ...
    return (
        <div className=" mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-8 lg:py-20">
            <h2 className="max-w-lg mb-12 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            ...
            <div className="my-16 grid gap-10 lg:grid-cols-2">
                <div className="flex items-center justify-center -mx-4 lg:pr-8">
                    <div className="flex flex-col items-end px-3">
                        <img
                            className="object-cover mb-6 rounded shadow-lg h-28 sm:h-48 xl:h-56 w-28 sm:w-48 xl:w-56"
                            src="https://i.ibb.co/y6bMkDq/Community-Association-Event-photo.jpg"
                            alt=""
                        />
                        <img
                            className="object-cover w-20 h-20 rounded shadow-lg sm:h-32 xl:h-40 sm:w-32 xl:w-40"
                            src="https://i.ibb.co/HhRKC6Q/Evening-Reception-photo.jpg"
                            alt=""
                        />
                    </div>
                    <div className="px-3">
                        <img
                            className="object-cover w-40 h-40 rounded shadow-lg sm:h-64 xl:h-80 sm:w-64 xl:w-80"
                            src="https://i.ibb.co/6vwLKH4/Sales-Kickoff-photo.jpg"
                            alt=""
                        />
                    </div>
                </div>
            ...
            <div className="grid gap-10 lg:grid-cols-2">
                ...
                <div className="flex items-center justify-center -mx-4 lg:pl-8">
                    <div className="flex flex-col items-end px-3">
                        <img
                            className="object-cover mb-6 rounded shadow-lg h-28 sm:h-48 xl:h-56 w-28 sm:w-48 xl:w-56"
                            src="https://i.ibb.co/YNMCD78/Product-Launch-photo.jpg"
                            alt=""
                        />
                        <img
                            className="object-cover w-20 h-20 rounded shadow-lg sm:h-32 xl:h-40 sm:w-32 xl:w-40"
                            src="https://i.ibb.co/xz1Khrf/Developer-Conference-photo.jpg"
                            alt=""
                        />
                    </div>
                    <div className="px-3">
                        <img
                            className="object-cover w-40 h-40 rounded shadow-lg sm:h-64 xl:h-80 sm:w-64 xl:w-80"
                            src="https://i.ibb.co/7kGqpSq/User-Conference-photo.jpg"
                            alt=""
                        />
                    </div>
                </div>
                        ...
                        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                            ...
                            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                                <span className="relative inline-block">
                                 ...
                                 Your Corporate Occasions with Precision Planning and Flawless Execution.
                            </h2>
